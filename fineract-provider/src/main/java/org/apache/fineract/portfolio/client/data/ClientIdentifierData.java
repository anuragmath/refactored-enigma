...
public class ClientIdentifierData {
    ...
    public static ClientIdentifierData singleItem(final Long id, final Long clientId, final CodeValueData documentType,
            final String status, final String documentKey, final String description) {
        return new ClientIdentifierData(id, clientId, documentType, status, documentKey, description, null);
    }
    ...
    public static ClientIdentifierData template(final ClientIdentifierData data, final Collection<CodeValueData> codeValues) {
        return new ClientIdentifierData(data.id, data.clientId, data.documentType, data.status, data.documentKey, data.description, codeValues);
    }

    public ClientIdentifierData(final Long id, final Long clientId, final CodeValueData documentType, final String status, final String documentKey,
